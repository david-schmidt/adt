...
1150 * VERSION 1.21B WORKS ON APPLE COMM CARD, HI BAUDRATE
1151 * (MOD BY PAUL SCHLYTER, APR 2000, PAUSCH@SAAF.SE)
...
2440 MOD0     BIT $C08F         ;RESET COMM CARD
2460          CMP #"S"          ;SEND?
...
4940          TAX
4950          LDA #$03
4960          STA $C000,X       ;RESET COMMCARD
4970          LDA #$11
4980          STA $C000,X       ;SET HI BAUDRATE ON COMMCARD
5000          STX MOD1+1        ;SELF-MODS FOR $C088+S0
5010          STX MOD3+1        ;IN GETC/PUTC
5020          INX
5030          STX MOD0+1        ;SELF-MODS FOR $C089+S0
5040          STX MOD2+1        ;IN MAIN LOOP AND
5050          STX MOD4+1        ;IN GETC AND PUTC
5070          LDY #3            ;ONLY ONE SPEED
...
10100          AND #$02
10110          BEQ PUTC1         ;OUTPUT REG FULL, LOOP
10120          PLA
...
10250          AND #$01
10260          BEQ GETC          ;INPUT REG EMPTY, LOOP
